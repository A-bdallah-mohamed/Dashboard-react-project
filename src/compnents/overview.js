...
<div className='grid grid-cols-6 gap-[35px] grid-rows-4 mt-[25px]'>
...
<div data-ripple-light="true" className='flex-col col-span-4 row-span-2 p-5 cursor-pointer bg-slate-300 shadow-md shadow-slate-400 hover:shadow-2xl hover:shadow-slate-600 transition-shadow    rounded-xl items-center flex '>
 ...
 <div className='px-3 py-3 grid grid-cols-5 gap-2 hover:bg-slate-100 relative text-xs rounded-lg'>
...
<div data-ripple-light="true" className='p-5 text-white cursor-pointer bg-zinc-900 shadow-md shadow-zinc-900 hover:shadow-2xl hover:shadow-zinc-900 transition-shadow row-span-2 col-span-2 rounded-xl  flex flex-col'>
<div>
