...
export default function Sidebar() {
  ...
  return (
    ...
    <ul className='text-white font-roboto-condensed'>
      <Link to='/'>
        <li className={location.pathname === '/' ? 'flex items-center w-[120px] justify-center h-[35px]	bg-lime-400 rounded-xl hover:bg-lime-700  mb-3 ' : 'flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 '}>
       <p>Dashboard</p>
        </li>
        </Link>
        <Link to='/pages/Memberland'>
        <li className={location.pathname === '/pages/Memberland' ? 'flex items-center w-[120px] justify-center h-[35px]	bg-lime-400 rounded-xl hover:bg-lime-700  mb-3 ' : 'flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 '}>
       <p>Memberland</p>
        </li>
        </Link>
         <li className={location.pathname === '/pages/Adminscape' ? 'flex items-center w-[120px] justify-center h-[35px]	bg-lime-400 rounded-xl hover:bg-lime-700  mb-3 ' : 'flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 '}>
       <p>Adminscape</p>
        </li>
         <li className={location.pathname === '/pages/Adminify' ? 'flex items-center w-[120px] justify-center h-[35px]	bg-lime-400 rounded-xl hover:bg-lime-700  mb-3 ' : 'flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 '}>
       <p>Adminify</p>
        </li>
         <li className={location.pathname === '/pages/Userinput' ? 'flex items-center w-[120px] justify-center h-[35px]	bg-lime-400 rounded-xl hover:bg-lime-700  mb-3 ' : 'flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 '}>
       <p>Userinput</p>
        </li>
         <li className={location.pathname === '/pages/Calendar' ? 'flex items-center w-[120px] justify-center h-[35px]	bg-lime-400 rounded-xl hover:bg-lime-700  mb-3 ' : 'flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 '}>
       <p>Calendar</p>
        </li>
         <li className={location.pathname === '/pages/Accordion' ? 'flex items-center w-[120px] justify-center h-[35px]	bg-lime-400 rounded-xl hover:bg-lime-700  mb-3 ' : 'flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 '}>
       <p>Accordion </p>
        </li>
        
    </ul>
    <li className={location.pathname === '/pages/Settings' ? 'absolute flex items-center w-[120px] justify-center h-[35px]	bg-cyan-400 rounded-xl hover:bg-cyan-700 bottom-5' : 'absolute flex items-center w-[120px] justify-center h-[35px]	 rounded-xl bg-slate-200 text-black mb-3 hover:bg-slate-400 bottom-2'}>
       <p>Settings </p>
        </li>
    </div>
    </div>
